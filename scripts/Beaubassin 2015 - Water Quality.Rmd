...
Beaubassin.Data <- read.csv("~/Documents/Master's/Data/Loder R data water quality 2015.csv", na.strings="NI", stringsAsFactors = FALSE)
Groundwater.Beaubassin <- read.csv("~/Documents/Master's/Data/CMR Groundwater Survey 2015.csv", na.strings="ND", stringsAsFactors = FALSE)
Weather.Data <- read.csv("~/Documents/Master's/Data/2015 Weather.csv", na.strings="NI", stringsAsFactors = FALSE)
